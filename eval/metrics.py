...
try:
    ...
    logging.warning("Advanced metrics not available. Install sentence-transformers and scikit-learn for full functionality.")
...
class RAGMetrics:
    ...
    def calculate_semantic_similarity(self, query: str, answer: str, expected_context: str = "") -> float:
    ...
    def _calculate_information_density(self, answer: str) -> float:
        ...
        technical_terms = len(re.findall(r'\b(?:Hz|RMS|SNR|dB|frequency|bearing|valve|gearbox|train|fan|slider|anomalous|normal|section|domain|target|source)\b', answer, re.IGNORECASE))
    ...
    def calculate_retrieval_accuracy(self, expected_file_count: Dict[str, int], 
                                   actual_files_mentioned: int) -> float:
    ...
    def calculate_response_completeness(self, query: str, answer: str, 
        ...
        for q_type in query_types:
            if q_type == 'what':
                ...
                has_comparison = any(word in answer_lower for word in ['both', 'while', 'whereas', 'compared', 'than'])
    ...
    def evaluate_response(self, query: str, expected_data: Dict[str, Any], 
                         actual_response: Dict[str, Any]) -> EvaluationScore:
        ...
        response_completeness = self.calculate_response_completeness(query, answer, expected_keywords)
    ...
    def batch_evaluate(self, evaluations: List[Tuple[str, Dict[str, Any], Dict[str, Any]]]) -> Dict[str, Any]:
        ...
        metrics = {}
        for metric_name in ["overall_score", "keyword_coverage", "semantic_similarity", 
                           "answer_quality", "retrieval_accuracy", "response_completeness",
                           "factual_consistency", "length_appropriateness", "technical_accuracy"]:
...
def main():
    ...
    actual = {
        "answer": "Based on the audio analysis, I found 3 bearing recordings in section 00 with dominant frequencies above 900 Hz. These include bearing_00_source_train_normal_000145.wav with a peak at 1024 Hz, bearing_00_target_train_normal_000201.wav at 950 Hz, and bearing_00_source_train_anomalous_000067.wav at 1156 Hz. The high frequencies might indicate bearing wear or misalignment issues."
    }
